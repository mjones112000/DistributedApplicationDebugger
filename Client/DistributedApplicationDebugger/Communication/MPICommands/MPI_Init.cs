...
{
  public class MPI_Init : MPICommand
  {
    public const string CommandName = "MPI_INIT";

    public MPI_Init(int sourceId):base(sourceId)
    {
    }

    public MPI_Init(int sourceId, int commandId, int lineNum, string[] parameterList):
